  ...
  try {
    ...
    try {
      jss setup `
        ...
        --layoutServiceHost "https://cm.starterkit.localhost" `
        --apiKey "7D57CC71-4E95-4A72-870C-7B13F4101151" `
        --deployUrl "https://cm.starterkit.localhost/sitecore/api/jss/import" `
        --deploySecret "DAD4F74D562749078B9AA7F7E22B8818" `
        --nonInteractive `
