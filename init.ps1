...
Add-HostsEntry "cm.starterkit.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.starterkit.localhost"
}
Add-HostsEntry "id.starterkit.localhost"
Add-HostsEntry "www.starterkit.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.starterkit.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.starterkit.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.starterkit.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.starterkit.localhost"
