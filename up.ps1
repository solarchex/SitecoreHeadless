...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.starterkit.localhost/ --auth https://id.starterkit.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.starterkit.localhost/ --auth https://id.starterkit.localhost/ --allow-write true
}
...
Start-Process https://cm.starterkit.localhost/sitecore/
Start-Process https://www.starterkit.localhost/
